...
const sugerencias = [];
Object.entries(conexionesPorNodo).forEach(([nodo, cantidad]) => {
    if (cantidad > 2) {
    sugerencias.push(`Nodo ${nodo} tiene ${cantidad} conexiones. Considera aumentar su ancho de banda o agregar redundancia.`);
    }
});
