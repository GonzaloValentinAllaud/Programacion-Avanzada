...
const paquetesFiltrados = paquetesDatos
    .filter(paquete => paquete.tamaño > 1000)   //Mayor a 1000 bytes
    .sort((a, b) => b.prioridad - a.prioridad); //Ordenar de mayor a menor por prioridad

console.log("Paquetes de datos filtrados y ordenados de mayor a menor segun la prioridad:");
