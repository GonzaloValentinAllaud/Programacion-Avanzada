...
for (const hora in traficoRed) {
    ...
    totalDatos += datos;
    if (datos > mayorTrafico) {
        mayorTrafico = datos;
        horaMayorTrafico = hora;
    }
}
console.log("Total de datos transferidos en el día: " + totalDatos + " MB");
console.log("Hora con mayor tráfico: " + horaMayorTrafico + " con " + mayorTrafico + " MB");